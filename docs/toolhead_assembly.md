...
|	Put the screws into the "feet" now, your hotend may be in the way later.<br/>2x M3x8 SHCS	|	<img src='assets/images/xol_toolhead/feet_screws.png' width=400 />	|
...
|	Time to move onto the extruder mount assembly. Install 2 or 3 heatset inserts and 2 hex nuts into your extruder mount.	|	<img src='assets/images/xol_toolhead/extruder_mount_heatsets_hexnuts.png' width=400 />	|
