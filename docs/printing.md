...
* Wall widths `Some of the supports have a built in "interface" layers. Make sure your printer profile allows printing of walls down to at least 0.4mm. Check that you can see them in your slicer before you print them.`
...
| ----------------------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| Rapido HF                           | [Xol_HE_Mount-Rapido_HF_Fan.stl](<../STL/HE Mounts/Xol_HE_Mount-Rapido_HF_Fan.stl>)                     | [Xol_HE_Mount-Rapido_HF_XolPAP.stl](<../STL/HE Mounts/Xol_HE_Mount-Rapido_HF_XolPAP.stl>)                     | Standard                       |
| Rapido UHF                          | [Xol_HE_Mount-Rapido_UHF_Fan.stl](<../STL/HE Mounts/Xol_HE_Mount-Rapido_UHF_Fan.stl>)                   | [Xol_HE_Mount-Rapido_UHF_XolPAP.stl](<../STL/HE Mounts/Xol_HE_Mount-Rapido_UHF_XolPAP.stl>)                   | UHF                            |
...
| DropEffect NeXtG (with extender)    | [Xol_HE_Mount-Rapido_HF_Fan.stl](<../STL/HE Mounts/Xol_HE_Mount-Rapido_HF_Fan.stl>)                     | [Xol_HE_Mount-Rapido_HF_XolPAP.stl](<../STL/HE Mounts/Xol_HE_Mount-Rapido_HF_XolPAP.stl>)                     | Standard                       |
