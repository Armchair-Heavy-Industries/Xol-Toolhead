...
| Four screws to attach the hotend cooling fan. They go through the front and rear faceplate printed parts, and the 2510 fan. <br/> 4x m3 x 20 SHCS (no fan heatsets `*don't over tighten`) <br/> 4x m3 x 16 SCHS (with fan heatsets) <br/> <br/>`If you're using LEDs, the middle one should be in the rear faceplate, with one hanging down each side towards where the ducts will go. The wires go over the top of the 2510 fan.` | <img src='images\xol_toolhead\fan_faceplate.png' width=300 /> |
